...
func TestInternals(t *testing.T) {
	...
	fullLogTopic := common.FromHex("0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f40")
	...
	for _, tc := range []struct {
		...
		{
			name: "CallTracer - full 64-byte log topic",
			code: append(
				append([]byte{byte(vm.PUSH1) + common.LogTopicLength - 1}, fullLogTopic...),
				byte(vm.PUSH1), 0x00,
				byte(vm.PUSH1), 0x00,
				byte(vm.LOG1),
			),
			tracer: mkTracer("callTracer", json.RawMessage(`{ "withLog": true }`)),
			want:   `{"from":"Q00000000000000000000000000000000FEED000000000000000000000000000000000000Feed0000000000000000000000000000000000000000000000000000","gas":"0x13880","gasUsed":"0x54ff","to":"Q00000000000000000000000000000000dEADbeeF00000000000000000000000000000000DEADbEEf000000000000000000000000000000000000000000000000","input":"0x","logs":[{"address":"Q00000000000000000000000000000000dEADbeeF00000000000000000000000000000000DEADbEEf000000000000000000000000000000000000000000000000","topics":["0x0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f40"],"data":"0x"}],"value":"0x0","type":"CALL"}`,
		},
		{
